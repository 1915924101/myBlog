    ...
    function(t, i, e) { (function(t) { !
      function() {
        ...
        i._$0s = 1,
          ...
          i._$62 = function(t, e) {
            try {
              ...
              if (r = o._$ST(), o._$gr(r), r > G._$T7) throw t._$NP |= i._$4s,
          ...
          _.end = function(t) {
            var i = _._$fT[t];
            return null != i ? w.getSystemTimeMSec() - i._$0S: -1
          },
          _._$li = function(t, i) {
            // console.log("_$li : " + t + "\n", i)
          },
          ...
          try {
            ...
            for (var h = i.length,
              ...
              var H = (m[0] - y[0]) / y[1],
                ...
                K = Math.ceil(j),
                tt = Math.ceil(J);
              if (g.identity(), g.translate(M, E), g.rotate(B), g.scale(1, m[1] / y[1]), g.shear(H, 0), g.scale(z, z), g.rotate( - N), g.translate( - O, -D), g.setContext(u), n || (n = 1.2), at.IGNORE_EXPAND && (n = 0), at.USE_CACHED_POLYGON_IMAGE) {
                var it = a._$e0;
        ...
        at._$yr = !1,
          ...
          at.init = function() {
            at._$6b && (// console.log("Live2D %s", at._$2s), at._$6b = !1, at.initProfile())
          },
      ...
      o.prototype = new n.L2DBaseModel,
        ...
        o.prototype.update = function() {
          ...
          var t = UtSystem.getUserTimeMSec() - this.startTimeMSec,
            i = t / 1e3,
            e = 2 * i * Math.PI;
          this.mainMotionManager.isFinished() && ("1" === sessionStorage.getItem("Sleepy") ? this.startRandomMotion(h.
